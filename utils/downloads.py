...
def attempt_download(file, repo='ultralytics/yolov5', release='v6.1'):
    ...
    :param file: 'runs\train\exp12\weights\best.pt'
    :param repo: 'ultralytics/yolov5'
    :param release: 'latest', 'v6.1', etc.
    :return: 直接返回输入file，'runs\train\exp12\weights\best.pt'，原地踏步
    '''
    from utils.general import LOGGER
